...
//{
//    public sealed class TranslatorHelperUserInternface2
//    {
//        #region Fields
...
//        //public TranslatorHelperApiRest(ITranslator translator) : this(translator, new[] { '\0' })
//        //{
...
//        public async Task<List<string>> CreateBlockListFromStringAsync(string text, CancellationToken cancellationToken = default)
//        {
...
//                result = await Task.Run(() => GenerateBlockListFromString(text, cancellationToken), cancellationToken);
//            }
//            catch (Exception ex)
//            {
//                throw;
...
//        public async Task<string> CreateStringFromBlockList(List<string> blockList, CancellationToken cancellationToken = default)
//        {
...
//        private string GenerateStringFromBlockList(List<string> blockList, CancellationToken cancellationToken = default)
//        {
//            string result = string.Empty;
...
//        #endregion
//        private List<string> GenerateBlockListFromString(string text, CancellationToken cancellationToken = default)
//        {
